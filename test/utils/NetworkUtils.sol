...
library NetworkUtils {
     ...
     */
    function getTestAmounts() internal view returns (uint256 orderAmount, uint256 userBalance, uint256 ethAmount) {
     ...
     */
    function getTestPriceLevels() internal view returns (uint256[] memory prices, uint256[] memory amounts) {
